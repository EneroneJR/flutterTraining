...
class AppSettings extends Table {
  ...
  late final monthlySalaryCents =
      integer().withDefault(const Constant(140000))();

  late final monthlySavingsTargetCents =
      integer().withDefault(const Constant(100000))();

  late final initialSavingsCents =
      integer().withDefault(const Constant(540000))();

  late final periodStartDay =
      integer().withDefault(const Constant(1))();

  late final referenceYear =
      integer().withDefault(const Constant(2026))();
...
class ExpenseMovements extends Table {
  ...
  late final description = text().withLength(
    min: 1,
    max: 250,
  )();
...
class FuelRefills extends Table {
  ...
  late final fuelType =
      text().withDefault(const Constant('GPL'))();
...
class AppDatabase extends _$AppDatabase {
  ...
  Future<bool> updateSettings(
    AppSettingsCompanion newSettings,
  ) {
...
OBJ: Aggiungere una spiegazione più in dentro del perchè i vari elementi.